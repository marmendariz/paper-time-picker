...
class PaperTimePicker extends mixinBehaviors([IronResizableBehavior], PolymerElement){
  ...
  static get observers(){
    return [ '_updateTime(hour, minute, second, enableSeconds)' ];
  }
